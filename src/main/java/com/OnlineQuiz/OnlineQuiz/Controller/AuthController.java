...
@RestController
@CrossOrigin(origins = { "onlinequizwin.netlify.app","http://127.0.0.1:5502", "http://localhost:5502","https://heroic-sunburst-56c10d.netlify.app","http://quizwiz-frontend.s3-website.ap-south-1.amazonaws.com","http://127.0.0.1:5504",
                "http://localhost:5504" })
@RequestMapping("/auth")
